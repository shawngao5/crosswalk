...
public class MessagingSmsManager {
    ...
    private Activity mMessagingHandler;
    ...
    public void onSmsSend(JSONObject jsonMsg) {
        ...
        PendingIntent piSent=PendingIntent.getBroadcast(mMessagingHandler, 
        ...
        intentSmsSent.putExtra(EXTRA_MSGTEXT, smsMessage);
        PendingIntent piDelivered=PendingIntent.getBroadcast(mMessagingHandler, 
            0, 
            intentSmsDelivered, 
            0);
    ...
    private void registerIntentFilters() {
        ...
        smsSentReceiver=new MessagingReceiver(messagingHandler) {
            ...
            public void onReceive(Context content, Intent intent) {
                ...
                try {
                    ...
                    mMessagingHandler.getContentResolver().insert(
        ...
        Intent intentReceived = mMessagingHandler.registerReceiver(smsReceiveReceiver,
        ...
        Intent intentSent = mMessagingHandler.registerReceiver(smsSentReceiver,
        ...
        Intent intentDelivered = mMessagingHandler.registerReceiver(smsDeliveredReceiver,
    ...
    private void unregisterIntentFilters(){
        mMessagingHandler.unregisterReceiver(smsReceiveReceiver);
        mMessagingHandler.unregisterReceiver(smsSentReceiver);
        mMessagingHandler.unregisterReceiver(smsDeliveredReceiver);
    }
}